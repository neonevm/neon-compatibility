...
const requestFaucet = async (wallet, amount) => {
  ...
  if (success !== true){
    console.log("Can't get a good response from faucet 10 times, please check faucet")
  }
};
...
const getBalance = async (address) => {
  ...
  if (success !== true){
    console.log("Can't get a good getBalance response 10 times, please check faucet settings")
  }
}
